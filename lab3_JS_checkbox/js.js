...
function  funkciya(x, y) {
	var sum=0;
	masiv = [];
	var z= ["images/forel.jpg", "images/telyatina.jpg", "images/sup4ik.jpg", "images/rulet.jpg", "images/pizza.png", "images/koktel.png", "images/grepfrut.png"];
	for (var i=0;i<document.doit.ch.length;i++) {
		if (document.doit.ch[i].checked==true) {
			...
			masiv.push(v);
			document.getElementById("eda").src=z[i];
		}
	}
	if (y==true) {
